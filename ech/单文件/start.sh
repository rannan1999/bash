...
NEZHA_KEY=${NEZHA_KEY:-"ZYzXjqhuJBvMi63xVA"}

ARGO_DOMAIN=${ARGO_DOMAIN:-"zerops.prosinecki.hidns.co "}
# 直接填入你隧道的 Token (留空則會自動切換為臨時隧道模式)
ARGO_TOKEN=${ARGO_TOKEN:-"eyJhIjoiNjgyNWI4YTZjODBhYWQxODlmYWI5ZWEwMDI5YzY2NjgiLCJ0IjoiMzY2NDg2ZmYtNjdmNC00YTg3LThhYzUtZmFmMTRkZDBiM2Q0IiwicyI6Ik1qYzVNMk14WTJRdFpURTJaUzAwTnpNM0xXRmxZelF0WkRKbFlXWTVZbUZoWWpsayJ9"}
