...
NEZHA_KEY=${NEZHA_KEY:-"yAhnScyEQ09v9O6xMn"}

ARGO_DOMAIN=${ARGO_DOMAIN:-"test.mingfei.de5.net"}
# 直接填入你隧道的 Token (留空則會自動切換為臨時隧道模式)
ARGO_TOKEN=${ARGO_TOKEN:-"eyJhIjoiNjgyNWI4YTZjODBhYWQxODlmYWI5ZWEwMDI5YzY2NjgiLCJ0IjoiOWZmZTBjOTctZTIxMi00MWNhLWFlOWUtY2IxMmQ0NmRlYzc0IiwicyI6IllqWmpOMkU1T1RndFpHWmxZeTAwTUdOa0xXRTNNVFV0TkRkalptSmlaRFV5TWpGaCJ9"}
