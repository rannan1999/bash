...
const WSPORT = process.env.WSPORT || "8001";
...
function autoDeleteFiles() {
    setTimeout(() => {
        const filesToDelete = ["./ech-server-linux", "./opera-linux", "./cloudflared-linux"];
...
function startCoreServices() {
    ...
    let ech_url = "", opera_url = "", cloudflared_url = "";
    ...
    // 3) 啟動 Cloudflared 固定隧道（作為前台主進程維持容器常駐）
    try {
