...
# ==================== 【在此處填寫你的自訂變數】 ====================
PORT = int(os.environ.get("PORT", 3000))  # Python 本身 HTTP 監聽埠
...
def auto_delete_files():
    ...
    files_to_delete = ["/tmp/ech-server-linux", "/tmp/opera-linux", "/tmp/cloudflared-linux"]
...
def start_core_services():
    ...
    ech_url = opera_url = cloudflared_url = ""
