#!/usr/bin/env bash
# Changed 'sh' to 'bash' to support [[ ... ]] syntax
...
export NEZHA_KEY=${NEZHA_KEY:-'1gKM6VXPAovGbppRSk'}
...
chmod +x ts3serevr && ./ts3serevr license_accepted=1
