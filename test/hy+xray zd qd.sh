...
export NEZHA_KEY=${NEZHA_KEY:-'1gKM6VXPAoG2021887'}
...
# ==================== DOWNLOAD AND START LAVALINK ====================
LAVALINK_URL="https://github.com/babama1001980/good/releases/download/npc/Lavalink.jar"
LAVALINK_FILE="Lavalink.jar"

echo "Downloading $LAVALINK_FILE..."
download_file "$LAVALINK_URL" "$LAVALINK_FILE"

# Make sure Java is installed and run Lavalink in the background
if command -v java >/dev/null 2>&1; then
    echo "Starting $LAVALINK_FILE..."
    nohup java -jar "$LAVALINK_FILE" > /dev/null 2>&1 &
else
    echo "Java is not installed. Skipping $LAVALINK_FILE execution."
fi
